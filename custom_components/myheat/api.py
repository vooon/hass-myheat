...
ENV_TYPE_OUTDOOR_TEMPERATURE = "outdoor_temperature"
ENV_TYPE_COMMON_TEMPERATURE = "common_temperature"
ENV_TYPE_PI_REGULATION_CIRCUIT = "pi_regulation_circuit"
ENV_TYPE_CIRCUIT_PRESSURE = "circuit_pressure"
ENV_TYPE_PRESSURE = "pressure"
...
WATER_HEATER_ENV_TYPES = {
    ...
    ENV_TYPE_PI_REGULATION_CIRCUIT,
    ENV_TYPE_COMMON_TEMPERATURE,
}
TEMPERATURE_ENV_TYPES = {
    ...
    ENV_TYPE_BOILER_TEMPERATURE,
    ENV_TYPE_DHW_TEMPERATURE,
    ENV_TYPE_OUTDOOR_TEMPERATURE,
    ENV_TYPE_COMMON_TEMPERATURE,
}
PRESSURE_ENV_TYPES = {
    ENV_TYPE_CIRCUIT_PRESSURE,
    ENV_TYPE_PRESSURE,
}

# Engineering component goal values (setEngGoal / local setObjState)
ENG_GOAL_AUTO = -1
ENG_GOAL_OFF = 0
ENG_GOAL_ON = 1
